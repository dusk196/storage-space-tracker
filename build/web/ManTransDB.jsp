<%-- 
    Document   : ManTransDB
    Created on : 3 May, 2017, 8:27:57 PM
    Author     : Sayantan
--%>
...
<html lang="en">
    <head>
        ...
        <title>NSA - Transaction Database</title>
                ...
                <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-edit"></i> Transaction Database
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row jumbotron">
                            <div class="col-md-6">
                                <h2>Amount calculator per user:</h2>
                                <form class="form-inline" method="post" action="ManTransDB.jsp">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="acpu" id="acpu" value="" placeholder="User ID">
                                    </div>
                                    <div class="form-group">
                                ...
                                <%
                                    String planid = null, plan = null, space = null, price = null, pdate = null, edate = null, day = null, acpu;

                                    int p = 0;

                                    acpu = request.getParameter("acpu");

                                    Class.forName("com.mysql.jdbc.Driver");
                                    java.sql.Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/sst", "root", "roy94");
                                    Statement st = conn.createStatement();
                                    ResultSet rst = st.executeQuery("select * from plandb where uid='" + acpu + "'");
                            ...
                            <div class="col-md-6">
                                <h2>Amount calculator per plan:</h2>
                                <form class="form-inline" method="post" action="ManTransDB.jsp">
                                    <div class="form-group">
                                        <label>Choose plan to check:</label>
                                        <select class="form-control" id="ptl" name="ptl">
                                ...
                                <%
                                    ...
                                    String p1 = request.getParameter("ptl");
                                    ...
                                    ResultSet rstt = stt.executeQuery("select * from plandb where plan='" + p1 + "'");

                                    while (rstt.next()) {
                                        price = rstt.getString(6);
                                        plantotal = plantotal + (Integer.parseInt(price));
                                    }
                        ...
                        <div class="row jumbotron">
                            <h1>Total amount: <c:out value="${total}" />/- incl. all taxes</h1>
                        </div>
                        <!-- /.row -->
