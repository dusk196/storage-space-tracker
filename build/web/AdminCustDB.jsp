<%-- 
    Document   : AdminCustDB
    Created on : 7 May, 2017, 5:13:33 PM
    Author     : Sayantan
--%>
                ...
                <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-edit"></i> Customer DB
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <sql:query dataSource="${snapshot}" var="result">select * from custdb where alvl = 'cust';</sql:query>
                            ...
                            <div class="row">
                                <h2>All registered in customer in database</h2>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <c:forEach var="row" items="${result.rows}">
                                            <tr>
                                        <form method="post" action="AdminCustDel">
                                            <td><input readonly type="text" name="uid" id="uid" value="${row.uid}"></td>
