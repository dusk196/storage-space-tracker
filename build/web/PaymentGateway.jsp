...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>Welcome <%=fnm%></h1>      
                <p>Thank you for buying additional space from us :)</p>
                <br><br>
                <p>You can add as much space as you want until the warehouse goes full. All of your subscription is separated and you can use those simultaneously.</p>
            </div>
            ...
            <div class="jumbotron">
                <center>
                    <form class="form-inline" method="post" action="BuySpace">
