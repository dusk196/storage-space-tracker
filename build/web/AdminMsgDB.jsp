<%-- 
    Document   : AdminMsgDB
    Created on : 7 May, 2017, 5:13:55 PM
    Author     : Sayantan
--%>
...
<html lang="en">
    <head>
        ...
        <title>NSA - Message Database</title>
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-edit"></i> Message DB
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/sst" user="root" password="roy94" />
                        <sql:query dataSource="${snapshot}" var="result">select * from msgdb;</sql:query>

                            <div class="row">
                                <h2>All messages in database</h2>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <c:forEach var="row" items="${result.rows}">
                                            <tr>
                                        <form method="post" action="AdminMsgDel">
                                            <td><input readonly type="text" name="msgid" id="msgid" value="${row.msgid}"></td>
                                            <td><c:out value="${row.fromrecv}" /></td>
                                            <td><c:out value="${row.sndrfnm}" /></td>
                                            <td><c:out value="${row.sndrlnm}" /></td>
                                            <td><c:out value="${row.torecv}" /></td>
                                            <td><c:out value="${row.sub}" /></td>
                                            <td><c:out value="${row.msgbody}" /></td>
                                            <td><c:out value="${row.tym}" /></td>
                                            <td><button class="btn btn-primary btn-sm" type="submit">DELETE</button></td>
                                        </form>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
