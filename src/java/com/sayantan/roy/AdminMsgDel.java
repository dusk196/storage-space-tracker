...
public class AdminMsgDel extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            int i = stmt.executeUpdate("DELETE FROM msgdb WHERE msgid='" + msgid + "' ");

            if (i != 0) {
                PrintWriter out = response.getWriter();
                System.out.println("Successfully Updated...");
                getServletContext().getRequestDispatcher("/AdminMsgDB.jsp").forward(request, response);
            }
