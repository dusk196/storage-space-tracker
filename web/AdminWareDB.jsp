<%-- 
    Document   : AdminWareDB
    Created on : 7 May, 2017, 5:13:03 PM
    Author     : Sayantan
--%>
...
<html lang="en">
    <head>
        ...
        <title>NSA - Warehouse Database</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <i class="fa fa-edit"></i> Warehouse DB
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <c:forEach var="row" items="${result.rows}">
                                            <tr>
                                        <form method="post" action="AdminSpaceDel">
