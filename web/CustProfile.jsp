<%-- 
    ...
    Created on : 29 Apr, 2017, 12:09:26 AM
    Author     : Sayantan
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <ol class="breadcrumb">
                                    <li>
                                        <i class="fa fa-dashboard"></i>  <a href="CustDash.jsp">Dashboard</a>
                                    </li>
                                    <li class="active">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form role="form" method="post" action="CustProfUpdate">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="alert alert-danger" style="background-color: #269abc;">
                                ...
                                <div class="alert alert-info">
                                    <strong>Heads up!</strong> We generate our invoice copy automatically. If you're changing your First name & Last name or any other thing it will reflect in your next invoices but not on which are previously generated.
                                </div>
                                <div class="alert alert-success">
                                    <strong>Changing email or phone?</strong> Please note that we might use these informations for verify your identity in case you forget your password. So, please input it correctly.
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
